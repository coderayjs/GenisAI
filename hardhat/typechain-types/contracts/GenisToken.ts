...
export interface GenisTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface GenisToken extends BaseContract {
  connect(runner?: ContractRunner | null): GenisToken;
  waitForDeployment(): Promise<this>;

  interface: GenisTokenInterface;
