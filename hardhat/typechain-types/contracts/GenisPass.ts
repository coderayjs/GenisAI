...
export interface GenisPassInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "TOTAL_SUPPLY"
      | "approve"
...
export interface GenisPass extends BaseContract {
  connect(runner?: ContractRunner | null): GenisPass;
  waitForDeployment(): Promise<this>;

  interface: GenisPassInterface;
